...
|---|---|---|---|
| S00 | Foundation and contracts | — | Buildable skeleton, interfaces, ownership rules, CI baseline |
| S01 | Artifact and IR | S00 | Deterministic `.sinf`, three IRs, converter/inspection tooling |
| S02 | `sm120` correctness backend | S01 | Validated Physical Plan executes reference-correct small graphs |
| S03 | Qwen3.8-27B end to end | S02 | Correct Qwen generation from `.sinf` on RTX 5090 |
| S04 | Kernel portfolio and specialization | S03 | Specialized provider portfolio with correct fallbacks |
| S05 | Autoresearch and decode experiments | S04 | Correctness-gated experiment/promotion loop; DSpark placed correctly |
| S06 | Reproducible performance proof | S05 | First checked RTX 5090 graph and evidence bundle |
| S07 | Gemma 4 26B-A4B extension | S06 | Second model added without executor edits |
| S08 | Hardening and V0 release | S07 | Compatibility, docs, release rehearsal, public V0 packet |
...
**Requirements:** ARCH-001, ARCH-004, ARCH-005, ARCH-008, QUA-001, QUA-003
...
**Requirements:** ARCH-001, ARCH-002, ARCH-003, ARCH-007, FMT-001–FMT-006, MOD-002, MOD-003
...
**Requirements:** BCK-001–BCK-006, KER-001, KER-002, KER-005, ARCH-004
...
**Requirements:** MOD-001–MOD-004, DEC-001, KER-006, FMT-003, BCK-004
...
**Requirements:** RES-001–RES-005, DEC-001–DEC-004, KER-004, BEN-001
...
**Requirements:** BEN-001–BEN-005, QUA-002, QUA-003, QUA-005
...
**Requirements:** MOD-005, ARCH-005, ARCH-006, KER-002, FMT-004, QUA-004
...
**Requirements:** QUA-001–QUA-005, REL-001, REL-002, FMT-002, BCK-003
