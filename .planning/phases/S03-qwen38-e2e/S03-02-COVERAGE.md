...
| gated dense FFN | `gated_dense_ffn` | unavailable | Layer-3 artifact fixture executes the pinned gate/up/down NVFP4 weights through ID 13 and ID 18; full reusable lowering/artifact path and GDN differential remain open |
